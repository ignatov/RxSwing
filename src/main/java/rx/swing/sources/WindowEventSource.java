...
public enum WindowEventSource {
    ...
    /**
     * @see rx.observables.SwingObservable#fromWindowEvents
     */
    public static Observable<WindowEvent> fromWindowEventsOf(final Window component) {
        return Observable.create(new OnSubscribe<WindowEvent>() {
            ...
            public void call(final Subscriber<? super WindowEvent> subscriber) {
                ...
                subscriber.add(SwingSubscriptions.unsubscribeInEventDispatchThread(new Action0() {
                    @Override
                    public void call() {
                        component.removeWindowListener(listener);
                    }
                }));
            }
        });
